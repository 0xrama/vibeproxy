...
update-backend: ## Update the bundled CLIProxyAPI backend to the latest release
	@./scripts/update-backend.sh latest

pin-backend: ## Re-fetch the pinned CLIProxyAPI backend version
